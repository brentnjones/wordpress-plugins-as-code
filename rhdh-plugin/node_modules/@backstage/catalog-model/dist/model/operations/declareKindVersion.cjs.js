...
var zod = require('../jsonSchema/zod.cjs.js');

const relationFieldSchema = v3.z.strictObject({
  /**
   ...
   */
  defaultKind: v3.z.string().optional(),
  /**
   ...
   */
  defaultNamespace: v3.z.enum(["default", "inherit"]).optional(),
  /**
   ...
   */
  allowedKinds: v3.z.array(v3.z.string()).optional()
});
const opDeclareKindVersionV1Schema = v3.z.strictObject({
  op: v3.z.literal("declareKindVersion.v1"),
  /**
   ...
   */
  specType: v3.z.string().optional(),
  /**
   * The properties that apply to this version.
   */
  properties: v3.z.strictObject({
    /**
     ...
     */
    relationFields: v3.z.array(relationFieldSchema).optional(),
    /**
     * The JSON schema of the version.
     */
    schema: v3.z.strictObject({
      jsonSchema: zod.jsonSchemaSchema
    })
  })
});
function createDeclareKindVersionOp(input) {
...
exports.createDeclareKindVersionOp = createDeclareKindVersionOp;
exports.opDeclareKindVersionV1Schema = opDeclareKindVersionV1Schema;
//# sourceMappingURL=declareKindVersion.cjs.js.map
