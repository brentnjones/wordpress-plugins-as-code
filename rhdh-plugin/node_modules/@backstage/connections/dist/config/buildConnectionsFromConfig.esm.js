...
import { combineConnectionSources } from './combineConnectionSources.esm.js';
import { getLegacyIntegrations } from './getLegacyIntegrations.esm.js';
import { getConnectionType, identityFields, isConnectionTypeKey } from './lookup.esm.js';
...
${describeError(e)}`
  ...
  for (const c of connections) {
    const connectionType = getConnectionType(c.type);
    if (connectionType.cardinality === "singleton") {
...
//# sourceMappingURL=buildConnectionsFromConfig.esm.js.map
