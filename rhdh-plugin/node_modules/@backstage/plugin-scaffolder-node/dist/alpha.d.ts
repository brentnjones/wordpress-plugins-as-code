...
import { TaskBroker, TemplateFilter, TemplateGlobal, SerializedTask, TaskFilter } from '@backstage/plugin-scaffolder-node';
import { z } from 'zod/v3';
import { JsonValue, JsonObject } from '@backstage/types';
import { TemplateParametersV1beta3, TemplateEntityStepV1beta3 } from '@backstage/plugin-scaffolder-common';
 ...
 * @alpha
 */
declare const scaffolderTemplatePermissionResourceRef: _backstage_plugin_permission_node.PermissionResourceRef<TemplateParametersV1beta3 | TemplateEntityStepV1beta3, {}, "scaffolder-template", "scaffolder">;
/**
 * Permission resource ref for scaffolder actions.
 * @alpha
 */
declare const scaffolderActionPermissionResourceRef: _backstage_plugin_permission_node.PermissionResourceRef<JsonObject, {}, "scaffolder-action", "scaffolder">;
/**
 * Permission resource ref for scaffolder tasks.
 * @alpha
 */
declare const scaffolderTaskPermissionResourceRef: _backstage_plugin_permission_node.PermissionResourceRef<SerializedTask, TaskFilter, "scaffolder-task", "scaffolder">;

export { createTemplateFilter, createTemplateGlobalFunction, createTemplateGlobalValue, restoreWorkspace, scaffolderActionPermissionResourceRef, scaffolderAutocompleteExtensionPoint, scaffolderTaskBrokerExtensionPoint, scaffolderTaskPermissionResourceRef, scaffolderTemplatePermissionResourceRef, scaffolderTemplatingExtensionPoint, scaffolderWorkspaceProviderExtensionPoint, serializeWorkspace };
