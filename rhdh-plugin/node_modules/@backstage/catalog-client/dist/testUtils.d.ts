...
declare class InMemoryCatalogClient implements CatalogApi {
    ...
    queryLocations(_request?: QueryLocationsRequest): Promise<QueryLocationsResponse>;
    streamLocations(_request?: QueryLocationsInitialRequest): AsyncIterable<Location[]>;
    ...
    updateLocation(_id: string, _location: {
        type?: string;
        target: string;
    }): Promise<Location>;
