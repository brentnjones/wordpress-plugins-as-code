...
declare class ConfigReader implements Config {
    ...
    constructor(data: JsonObject$1 | undefined, context?: string, fallback?: ConfigReader, prefix?: string);
...
export type { AppConfig, Config, JsonArray, JsonObject, JsonPrimitive, JsonValue };
